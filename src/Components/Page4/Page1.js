    ...
    <div style={{ backgroundColor: '#F5F8F8', width: '100%', height: 'auto', padding: '1%' }}>
      <div style={{ backgroundColor: '#FFFFFF', borderRadius: '16px', padding: '2%' }}>
        ...
        <div>
          ...
          <p style={{ color: '#121114', marginLeft: '34.5%', paddingTop: '30px', fontFamily: 'Poppins', fontWeight: '400', fontSize: '16px', lineHeight: '24px', marginBottom: '10px' }}>Enter up to 25 of your Zippyy order IDs <span style={{ fontSize: '10px', lineHeight: '15px' }}>(Comma separated)</span></p>
          ...
          <div style={{ marginTop: '40px', marginLeft: '41px', display: 'flex', justifyContent: 'center' }}>
            <div style={{ backgroundColor: '#F5F8F8', width: '36%', height: '151px', marginLeft: '10px', display: 'flex', flexDirection: 'column', }}>
